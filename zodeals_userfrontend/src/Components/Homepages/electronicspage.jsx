 ...
 useEffect(() => {
  ...
  fetchCoupons();
    ...
    <Box sx={{
      ...
      backgroundImage: `radial-gradient(ellipse at top right, rgba(14,165,233,0.07), transparent 60%), radial-gradient(ellipse at bottom left, rgba(2,132,199,0.04), transparent 60%), url(${premiumBg})`,
      ...
      <Container>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.2 }}>
            <Box sx={{
              ...
              fontSize: 20, boxShadow: '0 4px 14px rgba(14,165,233,0.35)',
            }}>
              💻
            </Box>
            <Typography sx={{
        ...
        {loading ? (
          ...
          <Grid container spacing={2} justifyContent="center">
            {coupons
              .filter(item => item.category?.title === "Electronics")
              .slice(0, 4)
              .map((item, index) => (
                <Grid item key={index}>
                  <CouponCard
