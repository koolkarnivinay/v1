    ...
    return (
      <Card
        sx={{
          ...
          '&:hover': { boxShadow: '0 6px 22px rgba(0,0,0,0.12)', transform: 'translateY(-2px)' },
        }}
      >
        <CardContent
          sx={{
  ...
  fetchCoupons();
    ...
    return (
      <Box sx={{
        ...
        backgroundImage: `radial-gradient(ellipse at top right, rgba(59,130,246,0.06), transparent 60%), radial-gradient(ellipse at bottom left, rgba(236,72,153,0.04), transparent 60%), url(${premiumBg})`,
        ...
        <Container>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.2 }}>
            <Box sx={{
              ...
              fontSize: 20, boxShadow: '0 4px 14px rgba(236,72,153,0.35)',
            }}>
              👔
            </Box>
            <Typography sx={{
        ...
        {loading ? (
          ...
          <Grid container spacing={2} justifyContent="center">
            {coupons
              .filter(item => item.category?.title === "Mens Fashion")
              .slice(0, 4)
              .map((item, index) => (
                <Grid item key={index}>
                  <CouponCard
