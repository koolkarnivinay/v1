  ...
  fetchCoupons();
    ...
    <Box sx={{
      ...
      backgroundImage: `radial-gradient(ellipse at top right, rgba(37,99,235,0.07), transparent 60%), radial-gradient(ellipse at bottom left, rgba(6,182,212,0.05), transparent 60%), url(${premiumBg})`,
      ...
      <Container>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.2 }}>
            <Box sx={{
              ...
              fontSize: 20, boxShadow: '0 4px 14px rgba(37,99,235,0.35)',
            }}>
              ✈️
            </Box>
            <Typography sx={{
        ...
        {loading ? (
          ...
          <Grid container spacing={2} justifyContent="center">
            {coupons
              .filter(item => item.category?.title === "Trips & Plans")
              .slice(0, 4)
              .map((item, index) => (
                <Grid item key={index}>
                  <CouponCard
