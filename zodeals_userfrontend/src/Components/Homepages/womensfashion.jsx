  ...
  fetchCoupons();
    ...
    return (
      <Box sx={{
        ...
        backgroundImage: `radial-gradient(ellipse at top right, rgba(236,72,153,0.06), transparent 60%), radial-gradient(ellipse at bottom left, rgba(147,51,234,0.05), transparent 60%), url(${premiumBg})`,
